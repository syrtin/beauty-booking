...
values
    ...
    (nextval('specialist_id_seq'), 'specialist 2', '+79216000000'),
    (nextval('specialist_id_seq'), 'specialist 3', '+79316000000');
...
-- Populating data for day_off table
insert into day_off (id, day_off_date, reason, specialist_id)
values
    (nextval('day_off_id_seq'), '2030-01-01', 'New Year', 1),
    (nextval('day_off_id_seq'), '2030-02-23', 'Defender of the Motherland Day', 2),
    (nextval('day_off_id_seq'), '2030-07-14', 'Bastille Day', 3);